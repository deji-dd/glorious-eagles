      ...
      >
          ...
          <ul>
            <li style={{ ...li_style, marginBottom: "2rem" }}>
              <p>
                ...
                interviews, observations, and assessments to gather information
                about the client's behavior, strengths, weaknesses, and goals.
              </p>
            </li>
            <li style={li_style}>
              <p>
                The therapist may also consult with caregivers, teachers, and
                other professionals to gain a comprehensive understanding of the
                client's needs.
              </p>
            </li>
          </ul>
          ...
          <ul>
            <li style={li_right}>
              <p>
                ...
                triggers of challenging behaviors. This involves data collection
                and analysis to determine the function of the behavior.
              </p>
            </li>
          </ul>
        ...
        <div style={div_style}>
          ...
          <ul>
            <li style={li_style}>
              <p>
                The therapist and client (or their caregivers) work together to
                set clear and measurable behavioral objectives. These objectives
                are specific, observable, and tailored to the client's needs and
                goals.
              </p>
            </li>
          </ul>
        ...
        <div style={div_right}>
          ...
          <h5 style={h5_right}>Designing a Behavior Intervention Plan (BIP)</h5>
          <ul>
            <li style={li_right}>
              <p>
                Based on the assessment and objectives, the therapist creates a
                BIP. This plan outlines the strategies and interventions that
                will be used to target and modify behaviors.
              </p>
            </li>
          </ul>
          <img src={Line} style={img_right} />
          ...
          <ul>
            <li style={li_style}>
              <p>
                ...
                evaluate the effectiveness of interventions, and make necessary
          ...
          <ul>
            <li style={li_right}>
              <p>
                ...
                include teaching new skills, using reinforcement strategies, or
                modifying the environment to reduce challenging behaviors.
              </p>
            </li>
          </ul>
          <img src={Line} style={img_right} />
          ...
          <ul>
            <li style={li_right}>
              <p>
                ...
                and caregivers to use ABA techniques and strategies consistently
                outside of therapy sessions. This helps generalize skills and
                behaviors to different settings
              </p>
            </li>
          </ul>
          <img src={Line} style={img_right} />
          ...
          <ul>
            <li style={li_style}>
              <p>
                ...
                the client's achievements and areas for improvement are shared.
                Adjustments to the treatment plan are made as needed.
              </p>
            </li>
          </ul>
          <img src={Line} style={img_style} />
        ...
        <div style={div_right}>
          ...
          <ul>
            <li style={li_right}>
              <p>
                When the client has achieved their goals and no longer requires
                intensive ABA therapy, a discharge plan is developed to ensure a
                smooth transition out of therapy while maintaining gains.
              </p>
            </li>
          </ul>
          <img src={Line} style={img_right} />
