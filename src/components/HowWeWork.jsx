      ...
      >
        <hr
          style={{
            ...
            flexShrink: "0",
            opacity: "0.1",
            background: "linear-gradient(295deg, #4563FF 9.05%, #4388DD 79.28%)",
            position: "absolute",
            margin: "0",
            left: "39.88rem",
          }}
        ...
        <AnimationOnScroll animateIn="animate__fadeInLeft" animateOut="animate__fadeOutLeft">
          <div style={div_style}>
            ...
            <ul>
              ...
              <li style={li_style}>
                <p>
                  The therapist may also consult with caregivers, teachers, and other professionals
                  to gain a comprehensive understanding of the client&apos;s needs.
                </p>
              </li>
            </ul>
            ...
            <ul>
              <li style={li_right}>
                <p>
                  ...
                  challenging behaviors. This involves data collection and analysis to determine the
        ...
        <AnimationOnScroll animateIn="animate__fadeInLeft" animateOut="animate__fadeOutLeft">
          <div style={div_style}>
            ...
            <ul>
              <li style={{ ...li_style, marginBottom: "2rem" }}>
                <p>
                  ABA therapy is highly individualized, and the therapist continuously assesses the
                  client&apos;s progress and adjusts interventions accordingly.
                </p>
              </li>
              <li style={li_style}>
                <p>
        ...
        <AnimationOnScroll animateIn="animate__fadeInLeft" animateOut="animate__fadeOutLeft">
          <div style={div_style}>
            ...
            <ul>
              <li style={li_style}>
                <p>
                  The therapist works to ensure that the client can generalize newly learned skills
                  and behaviors to various environments and situations. Maintenance strategies are
                  put in place to sustain progress over time.
                </p>
              </li>
            </ul>
            <img src={Line} style={img_style} />
        ...
        <AnimationOnScroll animateIn="animate__fadeInRight" animateOut="animate__fadeOutRight">
          <div style={div_right}>
            ...
            <ul>
              <li style={li_right}>
                <p>
                  For clients nearing the end of therapy or transitioning to a different program or
                  setting (e.g., school), the therapist may assist in developing a transition plan
                  to ensure a smooth transfer of skills and support.
                </p>
              </li>
            </ul>
            <img src={Line} style={img_right} />
