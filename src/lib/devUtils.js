...
export const generateTestFormData = () => {
  return {
    ...
    primaryInsuranceName: "Blue Cross Primary",
    primaryPmiNumber: "PMI-PRIMARY-123",
    secondaryInsuranceName: "Blue Cross Secondary",
    secondaryPmiNumber: "PMI-SECONDARY-456",
    ssn: "123-45-6789",
